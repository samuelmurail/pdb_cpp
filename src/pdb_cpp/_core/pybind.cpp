...
PYBIND11_MODULE(core, m) {
    py::class_<Model>(m, "Model")
        ...
        .def("set_x", &Model::set_x)
        .def("set_y", &Model::set_y)
        .def("set_z", &Model::set_z)
        .def("set_num", &Model::set_num)
        .def("set_beta", &Model::set_beta)
        .def("set_occ", &Model::set_occ)
        .def("set_resid", &Model::set_resid)
        .def("set_uniqresid", &Model::set_uniqresid)
        .def("set_name", &Model::set_name)
        .def("set_resname", &Model::set_resname)
        .def("set_elem", &Model::set_elem)
        .def("set_chain", &Model::set_chain)
        .def("set_alterloc", &Model::set_alterloc)
        .def("set_insertres", &Model::set_insertres)
    ...
    py::class_<Coor>(m, "Coor")
        ...
        .def("get_beta",      static_cast<const std::vector<float> &(Coor::*)(size_t) const>(&Coor::get_beta),      py::arg("frame") = 0)
        .def("get_occ",       static_cast<const std::vector<float> &(Coor::*)(size_t) const>(&Coor::get_occ),       py::arg("frame") = 0)
        .def("get_num",       static_cast<const std::vector<int> &(Coor::*)(size_t) const>(&Coor::get_num),         py::arg("frame") = 0)
        .def("get_resid",     static_cast<const std::vector<int> &(Coor::*)(size_t) const>(&Coor::get_resid),       py::arg("frame") = 0)
        .def("get_uniqresid", static_cast<const std::vector<int> &(Coor::*)(size_t) const>(&Coor::get_uniqresid),   py::arg("frame") = 0)
        .def("get_name",      static_cast<const std::vector<std::array<char, 5>> &(Coor::*)(size_t) const>(&Coor::get_name),      py::arg("frame") = 0)
        .def("get_resname",   static_cast<const std::vector<std::array<char, 5>> &(Coor::*)(size_t) const>(&Coor::get_resname),   py::arg("frame") = 0)
        .def("get_elem",      static_cast<const std::vector<std::array<char, 5>> &(Coor::*)(size_t) const>(&Coor::get_elem),      py::arg("frame") = 0)
        ...
        .def("set_beta",      &Coor::set_beta)
        .def("set_occ",       &Coor::set_occ)
        .def("set_num",       &Coor::set_num)
        .def("set_resid",     &Coor::set_resid)
        .def("set_uniqresid", &Coor::set_uniqresid)
        .def("set_name",      &Coor::set_name)
        .def("set_resname",   &Coor::set_resname)
        .def("set_elem",      &Coor::set_elem)
        .def("set_chain",     &Coor::set_chain)
