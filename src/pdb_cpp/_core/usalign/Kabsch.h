/*
 * Portions derived from US-align (https://github.com/pylelab/USalign).
 * References: Zhang et al. Nat Methods 2022; Zhang & Pyle iScience 2022.
 * License: see USALIGN_LICENSE.txt.
 */
#ifndef PDBCPP_USALIGN_KABSCH_H
#define PDBCPP_USALIGN_KABSCH_H
